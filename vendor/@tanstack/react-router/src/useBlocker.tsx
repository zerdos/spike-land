...
const _resolvePromptBlockerArgs = (props: PromptProps | LegacyPromptProps): UseBlockerOpts => {
...
export function Block(opts: PromptProps | LegacyPromptProps): React.ReactNode {
  ...
  return children ? (typeof children === "function" ? children(resolver as any) : children) : null;
}
