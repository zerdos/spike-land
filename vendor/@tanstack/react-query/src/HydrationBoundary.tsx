...
import type { DehydratedState, HydrateOptions, OmitKeyof, QueryClient } from "@tanstack/query-core";
...
export const HydrationBoundary = ({
  ...
  // updating the UI.
  const hydrationQueue: DehydratedState["queries"] | undefined = React.useMemo(() => {
    if (state) {
