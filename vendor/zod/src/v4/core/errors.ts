...
export interface $ZodIssueNotMultipleOf<Input extends number | bigint = number | bigint>
...
export const $ZodRealError: $constructor<$ZodRealError> = $constructor("$ZodError", initializer, {
  Parent: Error,
});
