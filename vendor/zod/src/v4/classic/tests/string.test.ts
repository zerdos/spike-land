...
test("E.164 validation", () => {
  ...
  expect(invalidE164Numbers.every((number) => e164Number.safeParse(number).success === false)).toBe(
    true,
  );
});
...
test("hash validation", () => {
  ...
  expect(
    sha384base64.parse("WeF0h3dEjGneawDXozO7+5/xtGPkQ1TDVTvNucZm+pASWjx5+QOXvfX2oT3oKGhP"),
  ...
  expect(
    defaultHash.parse("2cf24dba4f21d4288094c4a2e2c2d6c6b0c3e0c8f0e0c8f0e0c8f0e0c8f0e0c8"),
