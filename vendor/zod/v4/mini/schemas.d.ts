...
interface _ZodMiniNumber<
  T extends core.$ZodNumberInternals<unknown> = core.$ZodNumberInternals<unknown>,
> extends _ZodMiniType<T>,
...
export declare function object<T extends core.$ZodLooseShape = Record<never, SomeType>>(
  shape?: T,
...
export declare function extend<T extends ZodMiniObject, U extends core.$ZodLooseShape>(
  schema: T,
  shape: U,
...
export declare function safeExtend<T extends ZodMiniObject, U extends core.$ZodLooseShape>(
  schema: T,
...
export declare function pick<T extends ZodMiniObject, M extends util.Mask<keyof T["shape"]>>(
  schema: T,
...
export declare function omit<T extends ZodMiniObject, M extends util.Mask<keyof T["shape"]>>(
  schema: T,
  mask: M & Record<Exclude<keyof M, keyof T["shape"]>, never>,
...
export declare function partial<T extends ZodMiniObject>(
  ...
  T["_zod"]["config"]
>;
export declare function partial<T extends ZodMiniObject, M extends util.Mask<keyof T["shape"]>>(
  schema: T,
  mask: M & Record<Exclude<keyof M, keyof T["shape"]>, never>,
): ZodMiniObject<
  {
...
export declare function required<T extends ZodMiniObject>(
  ...
  T["_zod"]["config"]
>;
export declare function required<T extends ZodMiniObject, M extends util.Mask<keyof T["shape"]>>(
  schema: T,
  mask: M & Record<Exclude<keyof M, keyof T["shape"]>, never>,
): ZodMiniObject<
  util.Extend<
...
export declare function tuple<const T extends readonly [SomeType, ...SomeType[]]>(
  items: T,
...
>(items: T, rest: Rest, params?: string | core.$ZodTupleParams): ZodMiniTuple<T, Rest>;
export declare function tuple(
  items: [],
  params?: string | core.$ZodTupleParams,
): ZodMiniTuple<[], null>;
...
export declare function record<Key extends core.$ZodRecordKey, Value extends SomeType>(
  keyType: Key,
  valueType: Value,
  params?: string | core.$ZodRecordParams,
): ZodMiniRecord<Key, Value>;
export declare function partialRecord<Key extends core.$ZodRecordKey, Value extends SomeType>(
  keyType: Key,
  valueType: Value,
  params?: string | core.$ZodRecordParams,
): ZodMiniRecord<Key & core.$partial, Value>;
export declare function looseRecord<Key extends core.$ZodRecordKey, Value extends SomeType>(
  keyType: Key,
  valueType: Value,
  params?: string | core.$ZodRecordParams,
): ZodMiniRecord<Key, Value>;
...
export declare function codec<const A extends SomeType, B extends core.SomeType = core.$ZodType>(
  in_: A,
  out: B,
  params: {
    decode: (
...
> extends _ZodMiniType<core.$ZodFunctionInternals<Args, Returns>>,
  ...
  >(args: Items, rest?: Rest): ZodMiniFunction<ZodMiniTuple<Items, Rest>, Returns>;
...
>(params: { input: In; output: Out }): ZodMiniFunction<ZodMiniTuple<In, null>, Out>;
export declare function _function<
