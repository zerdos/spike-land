...
import {
  ...
  SPIKE_LAND_BASE_URL,
  textResult,
} from "../../core-logic/lib/tool-helpers";
...
export function registerBootstrapTools(
  ...
  registry.registerBuilt(
    t
      ...
      .handler(async ({ input, ctx }) => {
        return safeToolCall("bootstrap_workspace", async () => {
  ...
  registry.registerBuilt(
    t
      ...
      .meta({ category: "bootstrap", tier: "free" })
      .handler(async ({ input, ctx }) => {
        return safeToolCall("bootstrap_connect_integration", async () => {
  ...
  registry.registerBuilt(
    t
      ...
      .meta({ category: "bootstrap", tier: "free" })
      .handler(async ({ ctx }) => {
        return safeToolCall("bootstrap_status", async () => {
