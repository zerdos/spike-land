...
export type DisposeTask<K, V> = [value: V, key: K, reason: LRUCacheDisposeReason];
...
export type LRUCachePeekOptions<K, V, FC> = Pick<LRUCacheOptionsBase<K, V, FC>, "allowStale">;
