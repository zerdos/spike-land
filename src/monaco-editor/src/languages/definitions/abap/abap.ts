...
export const language = <languages.IMonarchLanguage>{
  ...
  operators: [
    ...
    "<",
    " >", // Leading space prevents premature matching: Monarch matches operators longest-first, so `->` and `=>` are matched before `>`. The space is a tokenizer workaround; to properly fix this, `>` would need to be handled in a separate tokenizer rule with negative lookahead.
    "<=",
    ">=",
    "<>",
    "><", // obsolete
