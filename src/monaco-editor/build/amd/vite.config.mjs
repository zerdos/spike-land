...
import { getEntryPoints, getNlsFiles, mapModuleIdAmd } from "../shared.mjs";
    ...
    build: {
      lib: {
        ...
        fileName: (_format, entryName) => {
          let result;
          const m = mapModuleIdAmd(join(root, entryName), ".js");
          if (m !== undefined) {
            result = m;
          } else {
            result = entryName + ".js";
        ...
        generateBundle() {
          for (const file of getNlsFiles()) {
            this.emitFile({
              ...
              source:
                "value" in file.source ? file.source.value : readFileSync(file.source.absolutePath),
            });
          }
        },
      },
