...
export declare function useReducer<S, I, A>(
  reducer: (state: S, action: A) => S,
  initialArg: I,
  init: (arg: I) => S,
): [S, Dispatch<A>];
...
export declare function useInsertionEffect(
  create: () => (() => void) | void,
  deps?: DependencyList,
): void;
export declare function useCallback<T extends (...args: unknown[]) => unknown>(
  callback: T,
  deps: DependencyList,
): T;
...
export declare function useOptimistic<S, A>(
  passthrough: S,
  reducer?: (state: S, action: A) => S,
): [S, (action: A) => void];
export declare function useActionState<S, P>(
