...
> **Last Updated**: January 2026 **Platform**: [spike.land](https://spike.land)
...
Welcome to Spike Land! Here's the fastest way to get started with **Orbit**,
...
A **workspace** is your isolated environment for managing social media accounts,
team members, and content.
...
**That's it!** You're now managing your social media presence from one unified
command center.
...
**What It Does**: Real-time health monitoring for your social media accounts
...
**What It Does**: Aggregates all mentions, DMs, and comments from all platforms
into one interface with AI-powered triage.
...
**What It Does**: AI-powered budget recommendations for social media advertising
with optional autopilot mode.
...
**What It Does**: Tracks competitors' social media activity and provides
benchmarking insights.

**Key Features**:

- **Competitor Tracking**: Monitor up to 10 competitors (PRO) or unlimited
  (BUSINESS)
...
**What It Does**: Centralized brand voice management and content guardrails to
...
**What It Does**: AI generates draft social media posts based on your brand
voice, with approval workflows.
...
**What Is a Workspace?** A workspace is an isolated environment for managing:
...
**To transfer workspace ownership** (e.g., handing off client to another
freelancer):
...
Orbit uses **workspace-level subscriptions** (not user-level). Each workspace
has its own tier.
...
- **Passive token generation**: 1 token every 15 minutes (cap depends on tier:
  10-100)
...
**What It Does**: Build landing pages, link-in-bio pages, and interactive
...
**Q: What's the difference between Orbit and Pixel?** A: **Orbit** is social
media management (workspace subscriptions). **Pixel** is image enhancement
(user-level tokens). They're separate products under the Spike Land umbrella.

**Q: Can I use Orbit for free?** A: Yes. The FREE tier supports 3 social
accounts with basic features. Upgrade to PRO ($29/mo) or BUSINESS ($99/mo) for
advanced features.

**Q: Do I need a separate subscription for each workspace?** A: Yes. Each
workspace (e.g., client account) requires its own subscription.
Freelancers/agencies get 15% off for 3+ workspaces.

### Features

**Q: Which social platforms does Orbit support?** A: Instagram, Facebook,
Twitter/X, LinkedIn, TikTok. More platforms coming soon (YouTube, Pinterest,
Snapchat).

**Q: Can Orbit post content automatically?** A: Yes. Use **Relay** to generate
drafts, then schedule them for future publishing.

**Q: Does Orbit provide analytics?** A: Yes. **Pulse** shows real-time metrics,
and you can export reports for stakeholders.

**Q: Can I track competitors?** A: Yes (PRO/BUSINESS tier). **Scout** monitors
competitors' public social media activity.

### Billing

**Q: Can I cancel anytime?** A: Yes. Cancel from **Settings → Billing**. Access
continues until end of billing period.

**Q: Do you offer annual billing?** A: Coming soon (20% discount: PRO $278/year,
BUSINESS $950/year).

**Q: What happens if I exceed my social account limit?** A: You'll be prompted
to upgrade or remove accounts. Existing connections remain active.

### Technical

**Q: Is my data secure?** A: Yes. We use OAuth (no passwords stored), encrypt
all data at rest and in transit, and comply with GDPR/CCPA.

**Q: Can I export my data?** A: Yes. Export all content, analytics, and settings
from **Settings → Data Export**.

**Q: Do you have an API?** A: Yes (BUSINESS tier). See
...
3. If you're managing a business account, connect via Facebook Business Manager
   first
...
4. Wait 5 minutes (sync runs every 5 minutes on FREE tier, every 1 minute on
   PRO/BUSINESS)
...
**Document Version**: 2.0 (Pivot Edition) **Last Updated**: January 2026
**Feedback**: docs@spike.land **Next Review**: April 2026
