	...
	[
		{
			...
			tokens: [
				...
				{ startIndex: 4, type: 'keyword.scala' } // Known limitation: Scala 2.13+ numeric literal separators (0x52_) are not supported by the Monarch tokenizer; the trailing `_` is incorrectly tokenized as a keyword
			]
		}
	],
