...
export const capabilities = {
	...
	textDocumentDiagnostic: new Capability<DiagnosticRegistrationOptions>(
	...
	textDocumentCompletion: new Capability<CompletionRegistrationOptions>(
	...
	textDocumentDefinition: new Capability<DefinitionRegistrationOptions>(
	...
	textDocumentCodeAction: new Capability<CodeActionRegistrationOptions>(
	...
	textDocumentDidSave: new Capability<TextDocumentSaveRegistrationOptions>(
...
export const api = contract({
	...
	server: {
		 ...
		 * that resolves to such.
		 */
		textDocumentColorPresentation: unverifiedRequest<
		 ...
		 * that resolves to such.
		 */
		textDocumentSelectionRange: unverifiedRequest<
		 ...
		 * @since 3.16.0
		 */
		textDocumentSemanticTokensFull: unverifiedRequest<
		 ...
		 * @since 3.17.0
		 */
		textDocumentDiagnostic: unverifiedRequest<
		 ...
		 * @since 3.17.0
		 */
		workspaceDiagnostic: unverifiedRequest<
		 ...
		 * reliable.
		 */
		textDocumentWillSaveWaitUntil: unverifiedRequest<
		 ...
		 */
		textDocumentCodeAction: unverifiedRequest<
			CodeActionParams,
		 ...
		 */
		codeActionResolve: unverifiedRequest<CodeAction, CodeAction>({
		 ...
		 */
		textDocumentPrepareRename: unverifiedRequest<
			PrepareRenameParams,
	...
	client: {
		 ...
		 */
		windowShowMessageRequest: unverifiedRequest<
			ShowMessageRequestParams,
			MessageActionItem | null
		>({ method: 'window/showMessageRequest' }).optional(),
		/**
		 ...
		 */
		windowShowMessage: unverifiedNotification<ShowMessageParams>({
