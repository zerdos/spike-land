      ...
      safeToolCall("pipelines_fork", async () => {
        ...
        const forked = await prisma.enhancementPipeline.create({
          data: {
            ...
            tier: source.tier,
            visibility: "PRIVATE",
            analysisConfig: source.analysisConfig ?? null,
            autoCropConfig: source.autoCropConfig ?? null,
            promptConfig: source.promptConfig ?? null,
            generationConfig: source.generationConfig ?? null,
          },
          select: { id: true, name: true },
        });
