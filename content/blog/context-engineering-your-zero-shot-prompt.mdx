...
<div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6 mb-8">
  ...
  <ul className="space-y-2 text-slate-300">
    <li>• Prompt engineering is outdated. Context engineering is the new standard.</li>
    <li>• Getting an AI to do something perfectly on the first try ("0-shot") requires front-loading context.</li>
    <li>• The formula: Identity + Knowledge + Examples + Constraints + Tools.</li>
    <li>• A simple `CLAUDE.md` file in your project is the secret weapon for AI consistency.</li>
  </ul>
</div>
